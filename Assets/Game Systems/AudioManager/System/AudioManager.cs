...
public class AudioManager : MonoBehaviour
{
    ...
    /// </summary>
    private AudioClip GetOrCacheNonAddressableClip(AudioClip clip)
    {
        ...
        return _nonAddressableClipCache.GetOrAdd(clipInstanceID, clip);
    }
    
    /// <summary>
    /// Preloads non-Addressable AudioClips into cache to prevent loading delays during gameplay.
    ...
    public static void PreloadClips(params AudioClip[] clips)
    {
        ...
        foreach (AudioClip clip in clips)
        {
            if (clip != null)
            {
                _instance.GetOrCacheNonAddressableClip(clip);
            }
        }
    }
    
    /// <summary>
    /// Preloads non-Addressable AudioClips from a list to prevent loading delays during gameplay.
    /// </summary>
